...
- *HTTP is a client / server architecture*

2. What are the different parts of an HTTP request?

- *A request line followed by various headers and potentially some sort of body content*
...
- *400 are for client errors, 500 are for server errors*
...
- *It is easier to parse the web code, easier to view headers, and easier to script repetitive tasks*
...
- *I guess not... this POST seems to be authenticating so maybe that's next*

20. What kind of data is being sent from this request body?

- *looks like a username and password for authentication*
